  ...
  return (
    <div className="min-h-screen bg-gray-100 py-4 px-2">
      <div className="max-w-5xl mx-auto">
        {/* Header Bar */}
        <div className="bg-[#626262] text-white px-4 py-3 text-lg font-semibold border border-b-0 border-gray-300">View VCC Details</div>
        {/* Section Bar */}
        <div className="bg-white border-x border-t border-gray-300 px-4 py-2 text-[16px] font-bold text-red-700 border-b-0">VCC/Vehicle Details</div>
        {/* Details Card */}
          ...
          <div className="bg-gray-100 py-3 px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
              ...
              <div className="flex text-[14px]">
                <span className="min-w-[140px] text-gray-600 font-medium">Status :</span>
